<%-- 
    Document   : admin
    Created on : 11 Mar, 2021, 1:26:41 AM
    Author     : h
--%>
...
<html >
  <head>
    <meta charset="UTF-8">
    <title>Manufacturer Login page</title>
...
<div class="login">
  <header class="login-header"><span class="text">Manufacturer</span><span class="loader"></span></header>
  <form class="login-form" name="f1" action="manu" method="post" onsubmit="return validatte()">
